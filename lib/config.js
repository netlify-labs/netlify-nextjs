// from https://github.com/netlify/netlify-lambda/blob/3115c1b78d84633b70d75f1068edcafb9162fbd1/lib/config.js
...
exports.loadContext = function(config) {
  ...
  var contextConfig = (process.env.CONTEXT && config.context && config.context[process.env.CONTEXT]) || {}
  var branchConfig = (process.env.BRANCH && config.context && config.context[process.env.BRANCH]) || {}
